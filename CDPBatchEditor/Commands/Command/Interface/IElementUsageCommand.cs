//  --------------------------------------------------------------------------------------------------------------------
//  <copyright file="IElementUsageCommand.cs" company="Starion Group S.A.">
...
namespace CDPBatchEditor.Commands.Command.Interface
{
    ...
    /// <summary>
    /// Defines an <see cref="IElementUsageCommand" /> that provides actions that are
    /// <see cref="ElementUsage" /> related.
    /// </summary>
    public interface IElementUsageCommand
    {
        /// <summary>
        /// Synchronises (overwrites) the <see cref="ElementUsage.ShortName" /> and <see cref="ElementUsage.Name" /> of
        /// every <see cref="ElementUsage" /> in the engineering model with the <see cref="ElementDefinition.ShortName" />
        /// and <see cref="ElementDefinition.Name" /> of the <see cref="ElementDefinition" /> it references.
        /// </summary>
        void SyncNames();
    }
}